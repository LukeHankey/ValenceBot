                            ...
                            if (!args[2]) {
                                ...
                                if (!rsn) {
                                    ...
                                    if (dataArr.length > userData.length) {
                                        let ranges = `January 2020!A${userData.length + 2}:F${dataArr.length + 1}`
