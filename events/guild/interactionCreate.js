...
||||||| parent of 5d0780b... Remove comments about permissions
=======
	// DEV
	if (interaction.guild.id !== '668330890790699079') return;

>>>>>>> 5d0780b... Remove comments about permissions
	const channels = {
		errors: {
			id: errors,
...
||||||| parent of 5d0780b... Remove comments about permissions
		...
		// const commandI = await client.guilds.cache.get('472448603642920973')?.commands.fetch();
		// const comF = commandI.filter(app => app.name === 'events').first();
		// const per = await comF.permissions.set({ permissions: [
		// 	{ // Admin
		// 		id: '473229033069346837',
		// 		type: 'ROLE',
		// 		permission: true,
		// 	},
		// { // Test Server Admin Role
		// 	id: '670707514186137610',
		// 	type: 'ROLE',
		// 	permission: true,
		// },
		// 	{ // Organiser
